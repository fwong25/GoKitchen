...
<script>
    ...
    methods: {
                ...
                response.json().then((data) => {
                    ...
                    if (this.recipe.Ingredients != null) {
                        for (let i = 0; i < this.recipe.Ingredients.length; ++i) {
                            this.recipe.Ingredients[i]["id"] = i+1;
                        }
                        this.ingredient_order_id = this.recipe.Ingredients.length
                    }  
                    else
        ...
        updateRecipe() {
            ...
            if (this.recipe.Ingredients != null)
                for(let i = 0; i < this.recipe.Ingredients.length; ++i) {
                    var ingredient = {
                        ...
                        amountUnit: this.recipe.Ingredients[i].AmountUnit
                    }
            ...
            fetch('http://localhost:8000/update_recipe',
                {
                    method: 'PUT',
                    mode: 'cors',
                    headers: {
        ...
        editIngredient(edit_ingredient_order_id) {
            ...
            this.edit_ingredient_name = this.recipe.Ingredients[edit_ingredient_order_id-1].IngredientName
            this.edit_amount = this.recipe.Ingredients[edit_ingredient_order_id-1].Amount
            this.edit_amount_unit = this.recipe.Ingredients[edit_ingredient_order_id-1].AmountUnit
        },
        deleteIngredient(ingredient_id) {
            ingredient_id -= 1
            this.recipe.Ingredients.splice(ingredient_id, 1)
            for(let i = ingredient_id; i < this.recipe.Ingredients.length; ++i) {
                this.recipe.Ingredients[i].id -= 1
            }
        },
        confirmEditIngredient() {
            this.recipe.Ingredients[this.edit_ingredient_order_id-1].IngredientName = this.edit_ingredient_name
            this.recipe.Ingredients[this.edit_ingredient_order_id-1].Amount = this.edit_amount
            this.recipe.Ingredients[this.edit_ingredient_order_id-1].AmountUnit = this.edit_amount_unit
        ...
        rescaleRecipe() {
            ...
            if(this.subrecipe_mode != "rescale") {
                ...
                for(let i = 0; i < this.recipe.Ingredients.length; ++i) {
                    this.recipe.Ingredients[i].NewAmount = this.recipe.Ingredients[i].Amount
                }

                this.recipe.RecipeRescaleInfo.RecipeID = this.recipe.RecipeID
                this.recipe.RecipeRescaleInfo.IngredientID = this.recipe.Ingredients[0].RecipeIngredientID
                if(isNaN(this.recipe.Ingredients[0].Amount))
                    this.recipe.RecipeRescaleInfo.NewAmount = -1
                else
                    this.recipe.RecipeRescaleInfo.NewAmount = parseInt(this.recipe.Ingredients[0].Amount)
            }
        },
        blankRecipe() {
        ...
        selectRescaleIngredient(ingredient_id) {
            if(!isNaN(this.recipe.Ingredients[ingredient_id-1].NewAmount)) {
                this.rescale_ing_id = ingredient_id-1
                this.rescale_amount = this.recipe.Ingredients[ingredient_id-1].NewAmount
            }
        },
        confirmRescaleIngredient() {
            // this.recipe.RecipeIngredients[this.rescale_ing_id].NewAmount = this.rescale_amount

            var scale = this.rescale_amount / this.recipe.Ingredients[this.rescale_ing_id].NewAmount
            console.log(scale)
            for(let i = 0; i < this.recipe.Ingredients.length; ++i) {
                this.recipe.Ingredients[i].NewAmount *= scale
            }

            this.recipe.RecipeRescaleInfo.RecipeID = this.original_recipe.RecipeID
            this.recipe.RecipeRescaleInfo.IngredientID = this.recipe.Ingredients[this.rescale_ing_id].RecipeIngredientID
            this.recipe.RecipeRescaleInfo.NewAmount = this.rescale_amount

            console.log(this.recipe.Ingredients[this.rescale_ing_id])
